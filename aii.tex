...
\begin{exe}[Fun\c c\~ao cont\'inua que satisfaz o teorema do valor intermedi\'ario, mas n\~ao \'e cont\'inua]
  Considere $f:[0,1]\ra \R$, dada por $f=(1-\iota)\chi_{]0,1[}$[\footnote{Aqui, $\chi$ \'e a fun\c c\~ao caracter\'istica e $\iota$ a identidade.}.
\end{exe}
