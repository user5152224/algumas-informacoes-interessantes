...
\begdoc
  ...
  A \rf{Defini\c c\~ao}{def2101262009} nos da formalmente a defini\c c\~ao de uma opera\c c\~ao recursiva. Particularmente, se $A=\R$ e $\meet=+$ em $\R$, ent\~ao temos a somat\'oria
  \[
    \sum_{i=1}^{n+1}a_n.
  \]
