...
\begin{teo}[39 Theorem]
  $\neg\varsigma(\U)$.
\end{teo}
\prova Consideremos a classe $\mathcal{R}=\{x:x\notin x\}$[\footnote{O ${\cal R}$ \'e em homenagem a Bertrand Russel, um dos primeiros a descobrir paradoxos na teoria ing\^enia dos conjuntos, criada pelo matem\'atico brilhante Georg Cantor.}. Provemos que $\neg\varsigma(\mathcal{R})$, i.e., $\mathcal{R}$. Para tanto, suponhamos por {\it reductio ad absurdum} que $\varsigma(\mathcal{R})$, temos ent\~ao a equival\^encia
\[
