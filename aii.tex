...
A seguir, apresento um resultado sem recorrer a resultados muito sofisticados da an\'alise.
\begin{pro}[Exerc\'icio 3 p. 146 do {\it Calculus} de [Spivak{]}]
  Se $f$ \'e cont\'inua em $[a,b]$, ent\~ao $f$ \'e uniformemente cont\'inua em $[a,b]$.
\end{pro}
\prova A prova faz o uso do {\it reductio ad absurdum}. Suponhamos, portanto, que $f$ n\~ao seja uniformemente cont\'inua em $[a,b]$. Bissectamos $[a,b]$ em dois intervalos, a saber, $[a,(a+b)/2]$ e $[(a+b)/2,b]$. Como $f$ n\~ao \'e uniformemente cont\'inua em $[a,b]$ ela tamb\'em n\~ao o ser\'a em pelo menos um destes subintervalos, pois caso contr\'ario recorra ao lema da p\'agina 145, e conclua que $f$ o \'e. Portanto incorremos numa contradi\c c\~ao. Dessarte, existe $K_1=[a_1,b_1]$ tal que $f$ n\~ao \'e uniformemente cont\'inua em $K_1$. Suponhamos constru\'ida a fam\'ilia $\{K_i:i\in n+1\}$ de intervalos tais que $K_1=[a_i,b_i]$, $|b_i-a_i|<2^{-i}(b-a)$ para todo $i\in n+1$ e $K_i\subset K_{i+1}$ para todo $i\in n$. Assim, bissectamos $K_{n}$, e necessariamente existe pelo menos um dos subintevalos, sobre o qual $f$ n\~ao \'e uniformemente cont\'inua. Destarte, podemos pela defini\c c\~ao por recurs\~ao conceber a fam\'ilia enumer\'avel $\{K_i:i\in\omega\}$, preservando aquelas propriedades. Pelo {\it Nested Interval Theorem} existe $x\in\bigcap_{n\in\omega} K_n$. Todavia, em virtude de $f$ n\~ao ser uniformemente cont\'inua em $K_n$, existem $x_n,y_n\in K_n$, tais que $|f(x_n)-f(y_n)|$
