...
%  \]
  ...
  \[
    \begin{aligned}
      G(u,v)&=(a\cos^2\theta+b\cos\theta\sin\theta+c\sin^2\theta)u^2+\bigl((a-c)\sin2\theta+b\cos2\theta\bigr)uv\cr
            &\qquad+(a\sin^2\theta-b\cos\theta\sin\theta+c\cos^2\theta)v^2+(d\cos\theta+e\cos\theta)u\cr
  ...
  \[
    \begin{aligned}
      ...
      \delta      &=d\cos\theta+e\cos\theta\cr
  ...
  Em suma, o que podemos concluir \'e que dada uma c\^onica, podemos sempre supor sem perda de generalidade que o termo quadr\'atico misto do polin\^omio subjacente $g$ \'e nulo.
