...
%  \]
  ...
  \begin{thebibliography}{}
    ...
    RUDIN, WALTER. {\it Principles of Mathematical Analysis}. $3^{\rm rd}$. McGraw-Hill, 1976.
    \bibitem{SpivakCalculus}
    SPIVAK, MICHAEL. {\it Calculus}. $4^{\rm th}$ ed. Houston, Texas: Publish or Perish, 2008.
  \end{thebibliography}
