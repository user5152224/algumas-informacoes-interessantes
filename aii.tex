...
\def\qed{\nopagebreak\ \hfill\rule{.42em}{1em}\bigskip}
\def\ra{\rightarrow}
...
\def\tvm{{\bf TVM}}
\def\U{{\cal U}}
\def\rf#1#2{{\scshape\bfseries\hyperref[#2]{#1 \ref{#2}}}}
...
\begin{teo}[34 Theorem]
  ...
  \]
\end{teo}
\prova Primeiramente suponhamos por {\it reductio ad absurdum} que exista $x\in\bigcap\U$, ent\~ao $\varsigma(x)$, pelo {\bf Teorema \ref{T26}} segue-se $\emptyset\subset x$; assim necessariamente $\varsigma(\emptyset)$, ou equivalentemente $\emptyset\in\U$. Pelo {\bf Teorema \ref{T32}} tem-se que $\bigcup\U\subset\emptyset$, novamente pelo {\bf Teorema \ref{T26}} temos $\emptyset\subset\bigcap\U$, logo, pelo {\bf Teorema \ref{T27}} e da suposi\c c\~ao inicial decorre que $x\in\bigcap\U=\emptyset$, o que \'e uma contradi\c c\~ao. Consequentemente, n\~ao \'e o caso que exista $x\in\bigcap\U$, i.e., $\bigcap\U=\emptyset$.\footnote{Segue a mesma linha de racioc\'inio de Kelley, apenas parafraseei.} 

Agora, seja $x\in\U$, pelo \AS existe $y\in\U$, tal que $x\in y$, pois $x\subset x$, pela defini\c c\~ao de $\bigcup\U$, segues-se que $x\in \bigcup\U$, consequentemente $\U\subset\bigcup\U$. Por outro lado, pelo {\bf Teorema \ref{T26}}, temos $\bigcup\U\subset\U$, consequentemente pelo {\bf Teorema \ref{T27}}, $\bigcup\U=\U$.\qed

\begin{teo}[35 Theorem]
  Para toda classe $x$, se $x\neq\emptyset$, ent\~ao $\varsigma(\bigcap x)$.
  \label{T35}
\end{teo}
\prova Se $x\neq\emptyset$, ent\~ao existe $y\in x$, logo $\varsigma(y)$ e pelo {\bf Teorema \ref{T32}} tem-se $\bigcap x\subset y$, da\'i e do {\bf Teorema \ref{T32}}, decorre que $\varsigma(\bigcap x)$.\qed 
...
\begin{teo}[37 Theorem]
  ...
  \label{T37}
\end{teo}
\prova Certamente pelo {\scshape Teorema \ref{T26}} segue que $2^\U\subset\U$. Agora, dado $x\in\U$, ent\~ao evidentemente $x\subset\U$, consquentemente $x\in 2^\U$. Pelo \rf{Teorema}{T27}, conclu\'imos que $2^\U=\U$.\qed
...
\begin{enumerate}[label = {\bf \Roman*.}]
  ...
  \item{
    Diferenciabilidade de $\ln|x|$\footnote{J\'a feita, apenas organizar.};
  }
  \item{
