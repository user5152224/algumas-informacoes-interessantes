...
\begdoc
  ...
  A seguir est\'a provado que no caso do sistema (\ref{S2912252034}) admitir infinitas solu\c c\~oes, o termo independente de $g$ no novo sistema de coordenadas \'e inexor\'avel \`a escolha da solu\c c\~ao do sistema (\ref{S2912252034}).
...
%  \]
  ...
  Uma outra maneira, mais geral \'e recorrer \`a \'algebra linear em conjunto com os recursos da geometria anal\'itica. Seja ${\mathcal B}=\{e_1,e_2\}$ a base can\^onica do $\R^2$. Uma base ortonormal, para o segundo sistema \'e 
  \[
  ...
  \]
  supondo evidentemente que $\theta\in\,]0,\pi[$. Esta conting\^encia n\~ao \'e t\~ao restritiva quanto se parece, pois fun\c c\~oes circulares s\~ao per\'iodicas de per\'iodo $2\pi$, podemos para fins de c\'alculo reduzir \^angulos ao intervalo $[0,2\pi]$; al\'em disso, se $\theta\in[\pi,2\pi]$, podemos considerar o outro ramo invers\'ivel de $\cos$, a saber, aquele cujo dom\'inio \'e $[-\pi,0]$. E por que n\~ao consideramos m\'ultiplos de $\pi$? A raz\~ao \'e que precipuamente, ter\'iamos os mesmo sistema de coordenadas, o que nos importa somente s\~ao os eixos, i.e., as retas correspondentes, n\~ao como s\~ao determinados.
