...
\begdoc
  ...
  A rela\c c\~ao das coordenadas de $(u,v)$ do sistema transladado com as coordenadas de $(x,y)$ segundo o sistema antigo \'e expressa pelo sistema
  \[
    \Biggl\{\,
    \begin{aligned}
      x&=u+h\cr
...
%  \]
  ...
  Consideremos um ponto $w=(u,v)_\theta$ cujas coordenadas s\~ao dadas em rela\c c\~ao ao sistema rotacionado. Nosso objetivo \'e determinar as coordenadas de $w$ relativo ao primeiro sistema. A t\'itulo de exemplo, usaremos um m\'etodo geom\'etrico para um caso particular.
  ...
  \begin{figure}[!h]
    ...
    \begin{tikzpicture}[
      ...
      \draw [->] \rot((0, -\st), \ang) -- \rot((0, 5), \ang) coordinate (V);
      \draw [->] \rot((-\st,0), \ang) -- \rot((5,0), \ang) coordinate (U);
  ...
  Seguirei a mesma linha de racioc\'inio empregada em \ct{Iezzi7}. Da geometria anal\'itica b\'asica temos
  \[
      \ora{OP_1}=\ora{P_2P},\quad\ora{OP_2}=\ora{P_1P},\quad\ora{OP_3}=\ora{P_4P},\quad\ora{OP_4}=\ora{P_3P}
  \]
  e
  \[
  ...
  Em s\'intese, obtemos a seguinte rela\c c\~ao das coordenadas do par $(x,y)$ no sistema anterior, em rela\c c\~ao \`as do par $(u,v)$, no novo sistema, nomeadamente
  \[
    \left\{\;
    \begin{aligned}
  ...
  Portanto, um vetor $w=(u,v)_\theta$ relativo \`a base ${\mathcal B}_\theta=\{r,s\}$, tem coordenadas satisfazendo o sistema (\ref{S0501262000}). Assim, as coordenadas $x$ e $y$ de $w$ relativas ao sistema can\^onico satisfazem a identidade
  \[
    \begin{bmatrix}
      x\cr
      y\cr
