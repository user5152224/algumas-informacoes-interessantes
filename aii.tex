...
\prova Primeiramente, suponha que $a<x<y<b$. Evidentemente $K_x\subset K_y$, por conseguinte do \rf{Lema}{PropSomaEmConjunto} $f(x)\leq f(y)$, segue-se (a).
  ...
  \[
    I=\Cap\bigl\{K_t:t\in\;]x,b[\bigr\}\neq\emptyset
    \label{eq2412251901}
  \]
  se, e somente se, existe $n\in\omega$, tal que $x=\sigma_n$. Com efeito, como $I\subset\mathfrak{I}\sigma$, se $I\neq\emptyset$, existe $n\in\omega$, tal que $\sigma_n\in I$. Da\'i segue que $\sigma_n\in K_t$, para todo $t\in\;]x,b[$, logo, $\sigma_n\in\;]x,t[$, para todo $t\in\;]x,b[$, consequentemente $\sigma_n=x$. A rec\'iproca n\~ao \'e dif\'icil\footnote{Provar.}.

  Assim, se $x\notin{\mathfrak I}\sigma=E$, ent\~ao $I=\emptyset$. Suponhamos que este seja o caso. Portanto, sejam $y\in\;]x,b[$ e $\varepsilon>0$, como $\sum\kappa_{K_y}(i)a_i<\infty$, existe $i_\varepsilon$, tal que 
  \[
