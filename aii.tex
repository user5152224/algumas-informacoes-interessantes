...
\begdoc
  ...
  \begin{Def}[Opera\c c\~ao recursiva]%
    ...
    \[
      \Meet_{i=k}^{n+k} a_i=f(n)
    \]
    para todo $n\in\omega$. Em particular, se $k=1$, temos naturalmente
    \[
  ...
  % TODO: Mostrar um exemplo que motive o pr\'oximo teorema
  ...
  \begin{teo}[Associatividade generalizada]%
    ...
    \[
      (u\meet v)\meet w=v\meet(v\meet w)
    \]
    para quaisquer $u,v,w\in A$. Ent\~ao a associa\c c\~ao dos termos num produto gen\'erico dos elementos do conjunto $\{a_{i+k}:i\in n+1\}$, com $n\in\omega$, \'e irrelevante. 
  \end{teo}
  \prova\qed
