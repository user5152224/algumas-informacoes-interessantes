...
%  \]
  ...
  Em conformidade com a figura estamos supondo que $\theta\in\,]0,\pi/2[$. Uma an\'alise geom\'etrica nos forne\c ce o seguinte sistema
  \[
    \left\{\;
    \begin{aligned}
      u&={x\over\cos\theta}+v\tan\theta\cr
      y&={v\over\cos\theta}+x\tan\theta\cr
    \end{aligned}
    \right.
    \label{S0501261935}
  \]
  Donde, multiplicando a primeira por $\cos\theta$, obtemos
  \[
    x=u\cos\theta-v\sin\theta,
  \]
  Substituindo $x$ na segunda equa\c c\~ao de (\ref{S0501261935}), deduz-se
  \[
    \begin{aligned}
      y&={v\over\cos\theta}+\tan\theta(u\cos\theta-v\sin\theta)\cr
       &={v\over\cos\theta}+u\sin\theta-{v\sin^2\theta\over\cos\theta}\cr
