...
\def\qed{\hfill\rule{.5em}{1em}\medskip}
...
\def\a{\;\wedge\;}
%\def\cp{\lower.15em\hbox{$\complement$}}
\def\cp{\mathbin{\neg}}
\def\o{\;\vee\,}
...
\lemma{}{\sl%
  Seja $K$ um corpo, para quaisquer $m,n\in N$ e $x,y\in K$ vale 
...
\definition{}{\sl%
  ...
  $$
    ...
    \left\{
    \begin{matrix}
      \hfill 1_K,  & m>0;\hfill \cr
      \hfill 0,    & m=0;\hfill \cr
      \hfill -1_K, & m<0,\hfill \cr
    \end{matrix}
    \right.\qquad\hbox{Def.}
  $$
  Al\'em disso, para $m\in Z$ definamos
  $$
    m^*=|m|*\sigma(m)\qquad\hbox{Def.}
  $$
  e
  $$
    m*x=m^*\cdot x\qquad\hbox{Def.}
  $$
}
...
\prova Provar usando os resultados ulteriores e mesclar.\qed
...
\begin{cor}
  Seja $K$ um corpo arbitr\'ario com caracter\'istica zero. Ent\~ao $K$ cont\'em uma c\'opia dos racionais.
\end{cor}
