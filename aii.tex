...
\begin{Def}
  Sejam $\sum a_n$ uma s\'erie convergente de termos estritamente positivos, e $A\subset\omega$. Seja $\kappa_A$ a caracter\'istica de $A$. Ent\~ao definimos
  \[
...
\begin{teo}[4.31 Remark: {\it Principles of Mathematical Analysis}]
  ...
  \end{enumerate}
\end{teo}
\prova Primeiramente, suponha que $a<x<y<b$. Evidentemente $[x]\subset [y]$, por conseguinte do \rf{Lema}{PropSomaEmConjunto} $f(x)\leq f(y)$, segue-se, portanto, (a).
