...
%  \]
  \subsubsection{Rota\c c\~oes de sistemas de coordenadas}
  ...
  Fazendo a substitui\c c\~ao de $(x,y)$ segundo (\ref{eq3001261537}) obtemos
  \[
    \begin{aligned}
  ...
  \[
    ...
    \label{eq0301261607}
  \]
  Conforme se sabe, $\cot$ tem restri\c c\~oes invers\'iveis em $\R\cp\pi\Z$. Se reduzirmos nossa escolha ao intervalo $[0,2\pi[$, temos duas solu\c c\~oes para (\ref{eq0301261607}), uma no semiciclo superior e a outra no semiciclo inferior.\qed
  ...
  \begin{thebibliography}{}
    ...
    CAMARGO, IVAN DE; BOULOS, PAULO. {\it Geometria Anal\'itica}. 3ª ed. rev. e ampl. S\~ao~Paulo, 2005.
  \end{thebibliography}
