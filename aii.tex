...
\begdoc
  ...
  \end{teo}
  \prova Para $p=0$ temos $a_0\meet a_1$ \'e completamente n\~ao amb\'iguo. Agora, suponhamos que a propriedade seja v\'alida para todo $q\in p+1$. Estipularemos que fixados $k,l\in\omega$, tais que $k\in l+1\in p+2$, o produto dos termos de uma sequ\^encia finita $a|_{l+1\cp k}$ seja denotado por
  \[
    \Meet_{j=k}^{l}a_j.
  \]
