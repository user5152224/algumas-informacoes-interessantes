...
\begin{teo}[\scshape 32 Theorem]
  \[
    \forall x,y\Bigl(x\in y\lra x\subset\bigcup y\a \bigcap\subset x\Bigr)
  \]
\end{teo}
...
\section{Anel dos inteiros}
\subsection{MMC e MDC}
\section{Anel dos polin\^omios}
\section{Anel das matrizes}
\section{Espa\c cos vetoriais}
\section{M\'odulos}
\section{Regra de tr\^es simples e composta}
