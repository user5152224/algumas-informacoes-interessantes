...
\titleformat{\section}{\centering\scshape\lsstyle\MakeUppercase}{\thesection}{1em}{}[]
\titleformat{\subsection}{\centering\scshape}{\thesubsection}{1em}{}[]
\titleformat{\subsubsection}{\centering\scshape}{\thesubsubsection}{1em}{}[]
...
\def\AS{{\bf AS}\ }
% TODO : Conflito de notação com reticulados
\def\a{\wedge}
\def\[{\begin{equation}}
\def\cal{\mathcal}
...
\begdoc
  ...
  Em outros termos, 
  \[
    M=\Cup_{E\in\Gamma}E=\sup\Gamma\in\Gamma
  \]  
  Conforme vimos em (\ref{eq0901261959}), segue-se que
  \[
    M\subset X\cp g(Y\cp f(M))\in\Gamma,
  \]
  consequentemente,
  \[
    M= X\cp g(Y\cp f(M)),
    \label{eq0901261938}
  \]
  pois, $M$ \'e o elemento m\'aximo. Finalmente, tomando $A=M$, segue de (\ref{eq0901261938}) que
  \[
    X\cp A=g\bigl(Y\cp f(A)\bigr).
  \]
  \qed
  ...
  \begin{teo}[Teorema do ponto fixo para reticulados\footnote{Enunciarei o teorema sob uma perspectiva mais geral seguindo o artigo de Tarski, que generalizou o teorema aplicado ao conjunto das partes de um conjunto arbitr\'ario para reticulados completos.}]%
    ...
    \begin{enumerate}[label = ({\rm\roman*})]
      ...
      \item{%
        $f\in X\ra X$ uma fun\c c\~ao crescente; 
      }
      \item{%
