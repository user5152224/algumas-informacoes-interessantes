...
\begdoc
  ...
  Dado um ponto $\varOmega=(h,k)$ de $\R^2$ e um vetor arbit\'ario $(x,y)$, as coordenadas $(u,v)$ de $(x,y)$ relativo ao sistema cuja origem \'e $\varOmega$ s\~ao simplesmente dadas pela identidade
  \[
    (u,v)=(x,y)-(h,k).
  \]
  ...
  A rela\c c\~ao das coordenadas $(u,v)$ do sistema transladado com as coordenadas do antigo \'e expressa pelo sistema
  \[
    \left\{
    \begin{aligned}
      x&=u+h\cr
