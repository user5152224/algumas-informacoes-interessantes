...
\begdoc
  ...
  \[
    \Meet_{j=k}^{l}a_j.
  \]
  Esta denota\c c\~ao \'e justificada pela nossa hip\'otese de indu\c c\~ao, pois $a|_{l+1\cp k}=b|_{l-k+1}$, com $b_m=a_{m+k}$, para todo $m\in l-k+1$, e todos as opera\c c\~oes com no m\'aximo $p+2$ termos s\~ao univocamente determinadas. 
