...
\begdoc
  ...
  Em seguida, da defini\c c\~ao $\bigcap\{x\}=\lge\varphi\rge$ e $\bigcup\{x\}=\lge\phi\rge$ em que
  \[
    \begin{split}
      \varphi(y)&\equiv\forall z(y\in\{x\}\lra z\in y)\a\varsigma(y)\cr
                &\equiv\forall z(y=x\lra z\in y)\a\varsigma(y)\cr
                &\equiv\forall z(z\in x)\a\varsigma(x)\cr
    \end{split}
  \]
  No entanto, nota-se que $x=\lge\varphi\rge$.
