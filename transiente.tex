...
Meu prop\'osito inicial era construir uma imers\~ao isom\'etrica de $X={\cal L}((R^m)^{p+1}, R^n)$ em $Y={\cal L}(\ell^1(R^m),R^n)$, para $p\in\omega$ fixo.

Para tal, definamos a seguinte aplica\c c\~ao ${\Lambda}:X\ra Y$ por:
$$
  \Lambda(T)(v)=T(v|_{p+1})\leqno(1)
$$
Sem muita dificuldade, prova-se que $\Lambda$ \'e linear e $\ker\Lambda=\{0\}$, {\it a fortiori}, $\Lambda$ \'e um isomorfismo linear. Ademais,
$$
  \|T\|=\sup\Bigl\{\|T(u)\|:u\in(R^m)^{p+1}\,\d\,\|u\|\leq 1\Bigr\}
$$
\'e igual a
$$
\|\Lambda(T)\|_1=\sup\Bigl\{\|\Lambda(T)(v)\|:v\in\ell^1(R^m)\,\d\,\|v\|_1\leq 1\Bigr\},
$$
